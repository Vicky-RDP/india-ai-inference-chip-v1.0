.PHONY: test test-stream processor-test mmio-test matrix-test scratchpad-test integration-test random-processor-test firmware-test reference unit random-test lint verilator-lint synth-report formal ci clean
...
ci: reference unit test test-stream processor-test mmio-test matrix-test scratchpad-test integration-test random-processor-test firmware-test random-test lint verilator-lint formal
